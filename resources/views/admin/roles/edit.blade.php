                ...
                <div class="card card-secondary card-outline">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="{!! old('name', $dataEditRole->name) !!}" @if($dataEditRole->name == 'Chủ sở hữu' || $dataEditRole->id == 1) disabled @endif>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="permissionBox">
                                ...
                                @foreach($Permission as $k => $item)
                                    <div class="custom-control custom-checkbox listpermissioncheck">
                                        ...
                                        value="{{$item->id}}" @if(in_array($item->id,$dataRoleOrPermission)) checked @endif>
